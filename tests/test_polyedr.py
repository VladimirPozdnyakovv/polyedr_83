...
4	1    4    8    5"""
    ...
    def test_task1(self):
        self.assertEqual(Polyedr("data/test1.geom").sum_spec(), 6.0)

    def test_task2(self):
        self.assertEqual(Polyedr("data/test2.geom").sum_spec(), 6.0)

    def test_task3(self):
        self.assertAlmostEqual(Polyedr("data/test3.geom").sum_spec(), 3.0)

    def test_task4(self):
        self.assertAlmostEqual(Polyedr("data/test4.geom").sum_spec(), 2.0)
